...
public final class EventCollector extends TimerTask implements ProfilingListener, CheckpointStateListener {
	...
	private static final class ExecutionStateListenerWrapper implements ExecutionStateListener {
		...
		public void executionStateChanged(final JobID jobID, final ExecutionVertexID vertexID,
			...
			final String taskName = this.vertex.getName();
	...
	public void registerAdditionalVertex(final ExecutionVertex vertex) {
		...
		// Register the listener object which will pass assignment changes on to the collector
		vertex
			.registerVertexAssignmentListener(new VertexAssignmentListenerWrapper(this, vertex.getExecutionGraph().getJobID()));
