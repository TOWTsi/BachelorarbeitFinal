...
import eu.stratosphere.nephele.jobmanager.JobManager.paraKillThread;
...
public class ServerTypeUtils {
	...
	public static List<Class<?>> getRPCTypesToRegister() {
		...
		types.add(StackTraceElement.class);
		types.add(CheckpointStateChangeEvent.class);
		types.add(TaskCheckpointResult.class);
		types.add(TaskKillResult.class);
		types.add(StringRecord.class);
		// Start Bachelorarbeit Vetesi
		types.add(FailureGenerator.class);
		types.add(ConfigurationHandler.class);
		types.add(paraKillThread.class);
